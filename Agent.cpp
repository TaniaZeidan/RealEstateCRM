...
Agent::Agent(int id, const std::string &firstName, const std::string &lastName,
    ...
    : m_id(id), m_firstName(firstName), m_lastName(lastName),
      m_phone(phone), m_email(email), m_startDate(startDate), m_endDate(endDate)
{}
...
std::string Agent::getStartDate() const { return m_startDate; }
std::string Agent::getEndDate() const { return m_endDate; }
...
void Agent::setStartDate(const std::string &startDate) { m_startDate = startDate; }
